  ...
  const handleStartLesson = async (lessonId: number) => {
    try {
      ...
      if (parts.length > 0) {
        ...
        alert("Bài học này chưa có nội dung nào!");
      }
    } catch (err) {
      console.error("Không thể tải lesson part:", err);
      alert("Lỗi khi mở bài học!");
    }
  };
      ...
      >
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "1. Bảng chữ cái",
                desc: "Học Hiragana, Katakana, phát âm chuẩn.",
              },
              {
                title: "2. Từ vựng Cốt lõi",
                desc: "Mở rộng vốn từ qua các chủ đề cơ bản.",
              },
              {
                title: "3. Ngữ pháp Chìa khóa",
                desc: "Thành thạo cấu trúc câu thông dụng.",
              },
              {
                title: "4. Giao tiếp tự tin",
                desc: "Luyện phản xạ và đối thoại thực tế.",
              },
              {
                title: "5. Ôn tập & Kiểm tra",
                desc: "Củng cố kiến thức với bài tập định kỳ.",
              },
              {
                title: "6. Hoàn thành & Chứng nhận",
                desc: "Đạt chứng chỉ sau khi hoàn thành khóa.",
              },
            ].map((item) => (
              <motion.div
                key={item.title}
        ...
        >
          ...
          <p className="text-gray-500 max-w-3xl mx-auto text-xl font-light mt-3">
            Hãy tham gia cùng cộng đồng học viên tinh hoa và xây dựng nền tảng
