...
import Avatar2 from "../assets/tin.jpg"
...
const AboutUs: React.FC = () => {
    ...
    return (
        <div className={`bg-[${BACKGROUND_LIGHT}] min-h-screen overflow-hidden font-nunito`}>
            ...
            {/* About Section - ĐÃ CẬP NHẬT NỘI DUNG SINH VIÊN */}
            <section 
                id="about-content" 
                ref={aboutRef}
            ...
            > 
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start"> 
                    <div className="lg:col-span-7 animate-fadeInLeft delay-300">
                        ...
                        <h2 className={`text-4xl md:text-4xl font-black ${TEXT_DARK} leading-tight mb-8`}> 
                        ...
                        <div className="p-8 rounded-xl shadow-2xl transition duration-500 bg-white hover:shadow-3xl border-l-[10px] border-transparent left-gradient-border hover:skew-x-1"> 
                            ...
                            <p className={`text-xl ${TEXT_MEDIUM} mb-5 italic font-semibold leading-relaxed`}> 
                                "Chúng tôi là một nhóm sinh viên trẻ, mang trong mình khát khao thay đổi cách học truyền thống. Với tinh thần sáng tạo và niềm đam mê công nghệ, chúng tôi xây dựng nền tảng học tập hiện đại, thú vị và đầy cảm hứng để trao quyền cho thế hệ tiếp theo."
                            </p>
                            <p className={`text-base ${TEXT_MEDIUM} border-t pt-4 mt-4 border-gray-100`}>
                                Nền tảng của chúng tôi là sự kết hợp hoàn hảo giữa sức trẻ, công nghệ tiên tiến (AI-Driven), dữ liệu lớn và phương pháp sư phạm hiện đại, đảm bảo hiệu quả học tập đột phá.
                            </p>
                        </div>
                        <a
                            href="#"
            ...
            {/* Core Values Section (Giữ nguyên) */}
            <section 
                ref={valuesRef}
            ...
            {/* Technologies Section (Giữ nguyên) */}
            <section 
                ref={techRef}
            ...
            > 
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10"> 
                    <TestimonialCard 
                        ...
                        title="Trưởng bộ môn CNTT"
                        avatar={Avatar1}
                    />
                    <TestimonialCard 
                        quote="Đội ngũ hỗ trợ cực kỳ chuyên nghiệp và tận tâm. Thầy thực sự ấn tượng với chất lượng và sự đổi mới mà các em mang lại trong mọi dự án."
                        name="Nguyễn Tín"
                        title="Giảng viên bộ môn tiếng Nhật"
                        avatar={Avatar2} 
                    />
                </div>
            </section>

            {/* Mission Section - ĐÃ CẬP NHẬT NỘI DUNG SINH VIÊN */}
            <section 
                ref={missionRef}
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-16 items-center"> 
                    ...
                    <div className="md:col-span-7 text-center md:text-left animate-fadeInLeft delay-500 order-2 md:order-1">
                        ...
                        <h2 className={`text-5xl md:text-6xl font-black ${TEXT_DARK} mb-7 leading-tight`}> 
                            Trao Quyền <span className={`text-[#00B8D9]`}>Thế Hệ</span> Sinh Viên Việt Nam
                        </h2>
                        <blockquote className={`text-xl ${TEXT_MEDIUM} leading-relaxed mb-8 border-l-4 border-[#00B8D9] pl-6 font-medium italic ${CARD_BG} p-7 rounded-xl shadow-lg`}> 
                            ...
                            "Chúng tôi tin vào việc trao quyền và kiến tạo giá trị khác biệt cho mỗi người học. Sứ mệnh của chúng tôi là biến sinh viên từ người theo đuổi thành người dẫn đầu, thông qua các giải pháp giáo dục thực chiến."
                        </blockquote>
